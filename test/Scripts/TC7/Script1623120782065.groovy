...
WebUI.click(findTestObject('Object Repository/Page_Funretro/form_RegisterFill your password and then we_b055cf'))
...
WebUI.waitForElementVisible(findTestObject('Page_Funretro/h2_Your private key'), 10)

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Funretro/h2_Your private key'))
